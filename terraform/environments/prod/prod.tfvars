...
mssql_public_key_file = "test-prod" #Need to remove this variable

mssql_ami = "ami-029f38f0f7288a049"

mssql_ec2_instance_type = "r5.xlarge"

mssql_js_user = "test-prod-user"
...
public_key_file = "test-prod" #Need to remove this variable

ami = "ami-08fe5144e4659a3b3"

ec2_instance_type = "t2.micro"

js_user = "test-prod-user"
